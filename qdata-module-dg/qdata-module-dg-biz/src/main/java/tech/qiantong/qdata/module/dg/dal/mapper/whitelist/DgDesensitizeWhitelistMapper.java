 ...
 * @date 2026-04-09
 */
public interface DgDesensitizeWhitelistMapper extends BaseMapperX<DgDesensitizeWhitelistDO> {

    default PageResult<DgDesensitizeWhitelistDO> selectPage(DgDesensitizeWhitelistPageReqVO reqVO) {
        Set<String> allowedColumns = new HashSet<>(Arrays.asList("id", "create_time", "update_time"));
        MPJLambdaWrapperX<DgDesensitizeWhitelistDO> lambdaWrapper = new MPJLambdaWrapperX<>();
        lambdaWrapper.selectAll(DgDesensitizeWhitelistDO.class)
