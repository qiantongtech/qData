...
package tech.qiantong.qdata.module.da.utils.model;
...
public class TaskSaveReqInput extends BaseEntity {
     ...
     * }
     *
     * 	1.	PARAMETER: indicates the parameter is passed as a URL parameter.
     * 	2.	BODY: indicates the parameter is passed as the request body, typically used in POST requests.
     * 	3.	HEADER: indicates the parameter is passed as part of the HTTP request headers.
     */
    ...
    public void addHttpParam(String prop, String httpParametersType, Object value) {
        ...
        this.httpParams.add(param); // Add the new parameter to the httpParams list
    }
}
