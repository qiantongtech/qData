        ...
        <el-form ref="roleRef" :model="form" :rules="rules" label-width="100px">
            ...
            <el-row :gutter="20">
                <el-col :span="12">
                    <el-form-item label="角色顺序" prop="roleSort">
                        <el-input-number style="width: 100%" v-model="form.roleSort" controls-position="right"
                            :min="0" />
                    </el-form-item>
                </el-col>
                <el-col :span="12">
            ...
            <el-form-item label="菜单权限">
                ...
                <el-tree class="tree-border" :data="menuOptions" show-checkbox ref="menuRef" node-key="id"
                    :default-expanded-keys="expandedKeys" :check-strictly="!form.menuCheckStrictly" empty-text="加载中，请稍候"
                    :props="{ label: 'label', children: 'children' }"></el-tree>
            </el-form-item>
            <el-form-item label="权限描述">
                <el-input v-model="form.remark" type="textarea" placeholder="请输入权限描述"></el-input>
            </el-form-item>
        </el-form>
        <template #footer>
        ...
        <el-form :model="form" label-width="80px">
            ...
            <el-form-item label="数据权限" v-show="form.dataScope == 2">
                ...
                <el-tree class="tree-border" :data="deptOptions" show-checkbox default-expand-all ref="deptRef"
                    node-key="id" :expanded-keys="expandedKeys" :check-strictly="!form.deptCheckStrictly"
