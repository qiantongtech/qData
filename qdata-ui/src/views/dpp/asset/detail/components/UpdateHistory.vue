<template>
    <el-dialog v-model="visible" class="dialog" draggable destroy-on-close>
        ...
        <el-table v-loading="loading" :data="list" border tooltip-effect="dark" :size="tableSize" :height="tableHeight"
            ...
            <el-table-column v-if="tableColumns.length > 0" label="序号" width="75" align="center">
            ...
            <el-table-column label="查看前后对比" align="center" width="150px">
...
import DataDiffDialog from "./DataDiffDialog";
