<template>
  <el-dialog title="数据资产-多选" v-model="visible" width="1200px" :append-to="$refs['app-container']" draggable
    destroy-on-close @close="cancel">
    <el-form class="btn-style" :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch"
      label-width="68px">
      <el-form-item label="资产名称" prop="name">
        <el-input style="width:240px" v-model="queryParams.name" placeholder="请输入资产名称" clearable
          @keyup.enter="handleQuery" />
      </el-form-item>
      <el-form-item label="类目编码" prop="catCode">
        <el-input style="width:240px" v-model="queryParams.catCode" placeholder="请输入类目编码" clearable
          @keyup.enter="handleQuery" />
      </el-form-item>
      <el-form-item label="主题id" prop="themeId">
        <el-input style="width:240px" v-model="queryParams.themeId" placeholder="请输入主题id" clearable
          @keyup.enter="handleQuery" />
      </el-form-item>
      <el-form-item label="数据连接id" prop="datasourceId">
        <el-input style="width:240px" v-model="queryParams.datasourceId" placeholder="请输入数据连接id" clearable
          @keyup.enter="handleQuery" />
      </el-form-item>
      <el-form-item label="表名称" prop="tableName">
        <el-input style="width:240px" v-model="queryParams.tableName" placeholder="请输入表名称" clearable
          @keyup.enter="handleQuery" />
      </el-form-item>
      <el-form-item label="表描述" prop="tableComment">
        <el-input style="width:240px" v-model="queryParams.tableComment" placeholder="请输入表描述" clearable
          @keyup.enter="handleQuery" />
      </el-form-item>
      <el-form-item label="数据量" prop="dataCount">
        <el-input style="width:240px" v-model="queryParams.dataCount" placeholder="请输入数据量" clearable
          @keyup.enter="handleQuery" />
      </el-form-item>
      <el-form-item label="字段量" prop="fieldCount">
        <el-input style="width:240px" v-model="queryParams.fieldCount" placeholder="请输入字段量" clearable
          @keyup.enter="handleQuery" />
      </el-form-item>
...
<script setup name="DaAssetMultiple">
...
function getList() {
  loading.value = true;
  listDaAsset(proxy.addDateRange(queryParams.value, dateRange.value)).then(
    async (response) => {
