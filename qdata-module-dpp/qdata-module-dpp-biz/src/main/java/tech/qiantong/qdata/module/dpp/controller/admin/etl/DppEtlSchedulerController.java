...
@Tag(name = "数据集成调度信息")
@RestController
@RequestMapping("/dpp/dppEtlScheduler")
@Validated
public class DppEtlSchedulerController extends BaseController {
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etlscheduler:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etlscheduler:export')")
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etlscheduler:import')")
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etlscheduler:query')")
    @GetMapping(value = "/{id}")
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etlscheduler:add')")
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etlscheduler:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etlscheduler:remove')")
