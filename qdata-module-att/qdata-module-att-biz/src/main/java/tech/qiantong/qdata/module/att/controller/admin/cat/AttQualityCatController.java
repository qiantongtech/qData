...
public class AttQualityCatController extends BaseController {
    ...
    @PreAuthorize("@ss.hasPermi('att:cat:attqualitycat:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('att:cat:attqualitycat:export')")
    ...
    @PreAuthorize("@ss.hasPermi('att:cat:attqualitycat:query')")
    @GetMapping(value = "/{id}")
