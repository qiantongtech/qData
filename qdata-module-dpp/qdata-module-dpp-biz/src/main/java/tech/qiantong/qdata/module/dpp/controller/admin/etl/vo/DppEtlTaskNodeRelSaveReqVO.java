...
/**
 * Data Integration Task Node Relation Create/Update Request VO DPP_ETL_TASK_NODE_REL
 *
 * @author qdata
 * @date 2025-02-13
 */
@Schema(description = "Data Integration Task Node Relation Save Request VO")
@Data
