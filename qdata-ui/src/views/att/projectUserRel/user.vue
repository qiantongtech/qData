            ...
            <el-row :gutter="15" class="btn-style">
                <el-col :span="1.5">
                    <el-button
                        ...
                        plain
                        @click="handleAdd"
                        v-hasPermi="['att:project:attprojectuserrel:add']"
                        @mousedown="(e) => e.preventDefault()"
                    >
                ...
                <el-col :span="1.5">
                    <el-button
                        ...
                        :disabled="multiple"
                        @click="handleDelete"
                        v-hasPermi="['att:project:attprojectuserrel:remove']"
                        @mousedown="(e) => e.preventDefault()"
                    >
            ...
            >
                <template #default="scope">
                    <el-button
                        ...
                        v-hasPermi="['att:project:attprojectuserrel:edit']"
                        >修改</el-button
                    >
                    <el-button
                        link
            ...
            <el-row :gutter="20">
                <el-col :span="24" v-if="form.id == null">
                    <div class="hint-div">
                        ...
                        <span>
                            如需添加新用户，请先点击‘‘<a href="/system/user" style="color: #2a7bfd"
                                >用户管理</a
                            >’’进行添加。
                        </span>
                    </div>
                ...
                <el-col :span="24" v-if="form.id == null">
                    <el-form-item label="系统用户" prop="userNameList">
                        ...
                        <el-button style="margin-left: 12px" type="primary" @click="getListUser"
                            >选择用户</el-button
                        >
                    </el-form-item>
                </el-col>
