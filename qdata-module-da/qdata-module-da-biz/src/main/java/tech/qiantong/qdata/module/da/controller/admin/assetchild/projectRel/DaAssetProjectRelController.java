...
@RestController
@RequestMapping("/da/daAssetProjectRel")
@Validated
public class DaAssetProjectRelController extends BaseController {
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.projectRel:assetprojectrel:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.projectRel:assetprojectrel:export')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.projectRel:assetprojectrel:import')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.projectRel:assetprojectrel:query')")
    @GetMapping(value = "/{id}")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.projectRel:assetprojectrel:add')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.projectRel:assetprojectrel:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.projectRel:assetprojectrel:remove')")
