...
@Tag(name = "数据元代码")
@RestController
@RequestMapping("/dp/dpDataElemCode")
@Validated
public class DpDataElemCodeController extends BaseController {
    ...
    @PreAuthorize("@ss.hasPermi('dp:dataElemCode:dataelemcode:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('dp:dataElemCode:dataelemcode:export')")
    ...
    @PreAuthorize("@ss.hasPermi('dp:dataElemCode:dataelemcode:import')")
    ...
    @PreAuthorize("@ss.hasPermi('dp:dataElemCode:dataelemcode:query')")
    @GetMapping(value = "/{id}")
    ...
    @PreAuthorize("@ss.hasPermi('dp:dataElemCode:dataelemcode:add')")
    ...
    @PreAuthorize("@ss.hasPermi('dp:dataElemCode:dataelemcode:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('dp:dataElemCode:dataelemcode:remove')")
