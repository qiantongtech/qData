      ...
      <el-row>
        ...
        <el-col :span="8" :offset="3">
          ...
          <el-checkbox
            ...
            v-if="readerForm.tableFields.length > 0"
            :disabled="info"
            >全选</el-checkbox
          >
          <draggable
        ...
        <el-col :span="4">
          <div class="arrow-container">
            <div
              v-for="(arrow, index) in arrowRows"
              :key="index"
              class="arrow-row fixed-height"
            >
              <div class="circle"></div>
              <div
                class="arrow-line"
                :class="{ 'show-arrow': arrow.showArrow }"
              ></div>
              <div class="circle"></div>
            </div>
          </div>
        ...
        <el-col :span="8">
          ...
          <el-checkbox
            ...
            v-if="readerForm.toColumnsList.length > 0"
            :disabled="info"
            >全选</el-checkbox
          >
          <draggable
