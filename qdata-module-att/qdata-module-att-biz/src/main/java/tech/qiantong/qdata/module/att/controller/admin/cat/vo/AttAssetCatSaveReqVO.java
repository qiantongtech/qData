...
/**
 * Data Asset Category Management Create/Update Request VO ATT_ASSET_CAT
 *
 * @author qdata
 * @date 2025-01-20
 */
@Schema(description = "数据资产类目管理 Response VO")
@Data
public class AttAssetCatSaveReqVO extends BaseEntity {
