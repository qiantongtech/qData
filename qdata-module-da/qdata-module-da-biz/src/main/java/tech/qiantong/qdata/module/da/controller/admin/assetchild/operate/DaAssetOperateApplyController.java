...
@Tag(name = "数据资产操作申请")
@RestController
@RequestMapping("/da/daAssetOperateApply")
@Validated
public class DaAssetOperateApplyController extends BaseController {
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.operate:assetoperateapply:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.operate:assetoperateapply:export')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.operate:assetoperateapply:import')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.operate:assetoperateapply:query')")
    @GetMapping(value = "/{id}")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.operate:assetoperateapply:add')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.operate:assetoperateapply:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.operate:assetoperateapply:remove')")
