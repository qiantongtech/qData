<template>
    ...
    <el-table stripe height="33.5vh" v-loading="loading" :data="dataList">
        ...
        <el-table-column label="维度" align="center" prop="dimensionTypeension" show-overflow-tooltip width="150">
            <template #default="scope">
