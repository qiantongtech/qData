...
public interface AiModelConvert {
     ...
     * @param aiModelPageReqVO request parameters
     * @return AiModelDO
     */
     ...
     * @param aiModelSaveReqVO save request parameters
     * @return AiModelDO
     */
     ...
     * @param aiModelDOList entity object list
