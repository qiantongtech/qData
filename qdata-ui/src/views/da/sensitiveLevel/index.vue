    ...
    <div class="app-container" ref="app-container">
        <div class="pagecont-top" v-show="showSearch">
            ...
            >
                ...
                <el-form-item label="替换规则" prop="sensitiveRule">
                    ...
                    >
                        <el-option
                            v-for="dict in da_sensitive_level_rule"
                            :key="dict.value"
                            :label="dict.label"
                            :value="dict.value"
                        />
        ...
        <div class="pagecont-bottom">
                ...
                <el-row :gutter="15" class="btn-style">
                    <el-col :span="1.5">
                        <el-button
                            ...
                            plain
                            @click="handleAdd"
                            v-hasPermi="['da:sensitiveLevel:sensitivelevel:add']"
                            @mousedown="(e) => e.preventDefault()"
                        >
                    ...
                    <!--         <el-col :span="1.5">-->
                    <!--           <el-button type="primary" plain :disabled="single" @click="handleUpdate" v-hasPermi="['da:sensitiveLevel:sensitivelevel:edit']"-->
                    <!--                      @mousedown="(e) => e.preventDefault()">-->
                    <!--             <i class="iconfont-mini icon-xiugai&#45;&#45;copy mr5"></i>修改-->
                    <!--           </el-button>-->
                    <!--         </el-col>-->
                    <!--         <el-col :span="1.5">-->
                    <!--           <el-button type="danger" plain :disabled="multiple" @click="handleDelete" v-hasPermi="['da:sensitiveLevel:sensitivelevel:remove']"-->
                    <!--                      @mousedown="(e) => e.preventDefault()">-->
                    <!--             <i class="iconfont-mini icon-shanchu-huise mr5"></i>删除-->
                    <!--           </el-button>-->
                    <!--         </el-col>-->
                    <!--         <el-col :span="1.5">-->
                    <!--           <el-button type="info" plain  @click="handleImport" v-hasPermi="['da:sensitiveLevel:sensitivelevel:export']"-->
                    <!--                      @mousedown="(e) => e.preventDefault()">-->
                    <!--             <i class="iconfont-mini icon-upload-cloud-line mr5"></i>导入-->
                    <!--           </el-button>-->
                    <!--         </el-col>-->
                    <!--         <el-col :span="1.5">-->
                    <!--           <el-button type="warning" plain @click="handleExport" v-hasPermi="['da:sensitiveLevel:sensitivelevel:export']"-->
                    <!--                      @mousedown="(e) => e.preventDefault()">-->
            ...
            >
                ...
                <!--       <el-table-column v-if="getColumnVisibility(6)" label="在线状态" align="center" prop="onlineFlag">-->
                <!--         <template #default="scope">-->
                ...
                >
                    <template #default="scope">
                        <el-button
                            ...
                            v-hasPermi="['da:sensitiveLevel:sensitivelevel:edit']"
                            >修改</el-button
                        >
                        <el-button
                            link
                            ...
                            v-hasPermi="['da:sensitiveLevel:sensitivelevel:remove']"
                            >删除</el-button
                        >
                        <!--           <el-button link type="primary" icon="view" @click="handleDetail(scope.row)"-->
                        <!--                      v-hasPermi="['da:sensitiveLevel:sensitivelevel:edit']">详情</el-button>-->
                        <!--           <el-button link type="primary" icon="view" @click="routeTo('/da/sensitiveLevel/daSensitiveLevelDetail',scope.row)"-->
                        <!--                      v-hasPermi="['da:sensitiveLevel:sensitivelevel:edit']">复杂详情</el-button>-->
                    </template>
                </el-table-column>
                    ...
                    <el-col :span="12">
                        <el-form-item label="在线状态" prop="onlineFlag">
                            <el-radio-group v-model="form.onlineFlag">
                                <el-radio
                                    v-for="dict in da_sensitive_status"
                                    :key="dict.value"
                                    :value="dict.value"
                                    >{{ dict.label }}</el-radio
                                >
...
<script setup name="DaSensitiveLevel">
    ...
    import { updateDaAsset } from '@/api/da/asset/daAsset.js';
    ...
    const data = reactive({
        ...
        rules: {
            sensitiveLevel: [{ required: true, message: '敏感级别不能为空', trigger: 'blur' }],
            maskCharacter: [{ required: true, message: '遮盖字符不能为空', trigger: 'blur' }],
