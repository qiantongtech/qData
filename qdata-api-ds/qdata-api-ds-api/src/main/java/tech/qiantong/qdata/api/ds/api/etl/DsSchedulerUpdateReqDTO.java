...
/**
 * <P>
 * Description: Scheduler update request DTO
 * </p>
 *
 * @author: FXB
...
public class DsSchedulerUpdateReqDTO {
    ...
    /**
     * Scheduler id (corresponds to ds_id in our scheduler table)
     */
    private Long id;

    /**
     * {
     * start time defaults to current time, format yyyy-MM-dd HH:mm:ss
