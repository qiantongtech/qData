...
@Tag(name = "数据资产-视频数据")
@RestController
@RequestMapping("/da/daAssetVideo")
@Validated
public class DaAssetVideoController extends BaseController {
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.video:assetvideo:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.video:assetvideo:export')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.video:assetvideo:import')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.video:assetvideo:query')")
    @GetMapping(value = "/{id}")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.video:assetvideo:add')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.video:assetvideo:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.video:assetvideo:remove')")
