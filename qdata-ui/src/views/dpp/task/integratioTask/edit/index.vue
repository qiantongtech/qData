    ...
    <div class="head-container">
      ...
      <div class="head-btns">
        ...
        >
          ...
          <img
            class="act"
            src="@/assets/images/dpp/etl/title-act (3).svg"
            alt=""
        ...
        >
          ...
          <img
            class="act"
            src="@/assets/images/dpp/etl/title-act (4).svg"
            alt=""
        ...
        >
          ...
          <img
            class="act"
            src="@/assets/images/dpp/etl/title-act (2).svg"
            alt=""
            ...
            <template #default="{ node, data }">
              ...
              >
                <img
                  ...
                  src="@/assets/images/common/dpp/srz.svg"
                  alt="icon"
                  class="icon-img"
                />
                <img
                  v-if="node.level === 1 && data.type == '3'"
                  src="@/assets/images/common/dpp/zh1.svg"
                  alt="icon"
                  class="icon-img"
                />
                <img
                  v-if="node.level === 1 && data.type == '2'"
                  src="@/assets/images/common/dpp/sc.svg"
                  alt="icon"
                  class="icon-img"
                />
                <img
...
const getDatasourceIcon = (json) => {
  ...
  switch (type) {
    case "FLINK":
      return new URL("@/assets/images/common/dpp/Flink.svg", import.meta.url)
        .href;
    case "SPARK":
      return new URL("@/assets/images/common/dpp/Spark.svg", import.meta.url)
        .href;
    default:
      return null;
  }
