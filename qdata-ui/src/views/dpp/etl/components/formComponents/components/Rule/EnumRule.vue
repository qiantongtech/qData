    ...
    <el-form ref="formRef" :model="form" label-width="130px" :disabled="falg">
        <div v-loading="loadingList">
            ...
            <el-table stripe :data="form.stringValue" v-loading="loading">
                <el-table-column label="原值" align="center" prop="value">
                    <template #default="scope">
                        <el-input v-model="scope.row.value" style="width: 100%" placeholder="请输入原值" />
                    </template>
                </el-table-column>

                <el-table-column label="标准值" align="center" prop="name">
                    <template #default="scope">
...
import SingleSelectTableDialog from "./EnumRuleDialog/SingleSelectTableDialog.vue";
