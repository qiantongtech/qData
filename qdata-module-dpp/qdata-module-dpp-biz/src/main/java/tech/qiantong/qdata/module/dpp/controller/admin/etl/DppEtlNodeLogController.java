...
@Tag(name = "数据集成节点-日志")
@RestController
@RequestMapping("/dpp/dppEtlNodeLog")
@Validated
public class DppEtlNodeLogController extends BaseController {
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etlnodelog:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etlnodelog:export')")
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etlnodelog:import')")
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etlnodelog:query')")
    @GetMapping(value = "/{id}")
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etlnodelog:add')")
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etlnodelog:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etlnodelog:remove')")
