         ...
         <el-table stripe v-loading="loading" :data="noticeList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width"  fixed="right" width="240">
               <template #default="scope">
                  ...
                  <el-button link type="primary" icon="View" @click="handleView(scope.row)" v-hasPermi="['system:notice:detail']">详情</el-button>
...
function handleView(row) { 
  router.push({ path: '/system/notice/detail', query:{id:row.noticeId}});
}
