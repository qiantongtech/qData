...
/**
 * ai chat conversation create/modify Request VO AI_CHAT_CONVERSATION
 *
 * @author FXB
 * @date 2026-04-01
 */
...
@Data
public class AiChatConversationSaveReqVO extends BaseEntity {
    ...
    @Size(max = 256, message = "对话标题长度不能超过256个字符")
    private String title;

    @Schema(description = "是否置顶;0：不置顶，1：置顶", example = "")
    @Size(max = 256, message = "是否置顶;0：不置顶，1：置顶长度不能超过256个字符")
