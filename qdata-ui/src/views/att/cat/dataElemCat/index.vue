    ...
    <div class="app-container" ref="app-container">
        <div class="pagecont-top" v-show="showSearch">
            <el-form class="btn-style" :model="queryParams" ref="queryRef" :inline="true" label-width="75px">
                <el-form-item label="数据元类目名称" prop="name" label-width="110">
                    <el-input class="el-form-input-width" v-model="queryParams.name" placeholder="请输入数据元类目名称" clearable
                        @keyup.enter="handleQuery" />
                </el-form-item>
                <el-form-item label="上级类目" prop="code">
                    <el-tree-select filterable class="el-form-input-width" v-model="queryParams.code"
                        :data="attDataElemCatOptions" :props="{ value: 'code', label: 'name', children: 'children' }"
                        value-key="id" placeholder="请选择上级" check-strictly />
                </el-form-item>
                <el-form-item>
                    <el-button plain type="primary" @click="handleQuery" @mousedown="(e) => e.preventDefault()">
                        <i class="iconfont-mini icon-a-zu22377 mr5" v-hasPermi="['att:dataElemCat:query']"></i>查询
                    </el-button>
        ...
        <div class="pagecont-bottom">
                ...
                <el-row :gutter="10" class="btn-style">
                    <el-col :span="1.5">
                        <el-button type="primary" plain icon="Plus" @click="handleAdd"
                            v-hasPermi="['att:dataElemCat:add']">新增</el-button>
                    </el-col>
            ...
            <el-table height="60vh" v-if="refreshTable" v-loading="loading" :data="attDataElemCatList" row-key="id"
                :default-expand-all="isExpandAll" :tree-props="{ children: 'children', hasChildren: 'hasChildren' }">
                <el-table-column label="数据元类目名称" align="left" prop="name" width="200"
                ...
                <el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right"
                    ...
                    <template #default="scope">
                        <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                            v-hasPermi="['att:dataElemCat:edit']">修改</el-button>
                        <el-button link type="primary" icon="Plus" @click="handleAdd(scope.row)"
                            v-hasPermi="['att:dataElemCat:add']">新增</el-button>
                        <el-button link type="danger" icon="Delete" @click="handleDelete(scope.row)"
                            v-hasPermi="['att:dataElemCat:remove']">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <el-dialog :title="title" v-model="open" width="800px" :append-to="$refs['app-container']" draggable
            destroy-on-close>
            <el-form ref="attDataElemCatRef" :model="form" :rules="rules" label-width="80px">
                <el-row :gutter="20">
                    <el-col :span="12">
                        <el-form-item label="类目名称" prop="name">
                            <el-input v-model="form.name" placeholder="请输入数据元类目名称" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
...
const data = reactive({
    ...
    rules: {
        name: [{ required: true, message: '数据元类目名称不能为空', trigger: 'blur' }],
...
function handleStatusChange(row) {
    ...
    proxy.$modal
        .confirm(`确认要"${text}","${row.name}"数据元类目吗？`)
        .then(() => {
...
function handleDelete(row) {
    proxy.$modal
        .confirm('是否确认删除数据元类目管理编号为"' + row.name + '"的数据项？')
        .then(function () {
