<template>
        ...
        <el-row :gutter="15" class="btn-style">
            <el-col :span="1.5">
                <el-button
                    ...
                    plain
                    @click="handleAdd"
                    v-hasPermi="['dataElemCode:dpDataElemCode:add']"
    ...
    >
        ...
        <el-table-column label="代码值" align="center" prop="codeValue" width="160">
        ...
        >
            <template #default="scope">
                <el-button
                    ...
                    v-hasPermi="['dataElemCode:dpDataElemCode:edit']"
                    >修改</el-button
                >
                <el-button
                    link
                    ...
                    v-hasPermi="['dataElemCode:dpDataElemCode:remove']"
                    >删除</el-button
                >
            </template>
        </el-table-column>
    ...
    >
        <el-form ref="dpDataElemCodeRef" :model="form" :rules="rules" label-width="80px">
            <el-row :gutter="20">
                ...
                <el-col :span="12">
                    <el-form-item label="代码名称" :show-overflow-tooltip="true" prop="codeName">
            ...
            <el-row :gutter="20">
                <el-col :span="24">
                    <el-form-item label="备注" :show-overflow-tooltip="true" prop="remark">
