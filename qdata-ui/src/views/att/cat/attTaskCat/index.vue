                ...
                <el-row :gutter="15" class="btn-style">
                    <el-col :span="1.5">
                        <el-button
                            ...
                            plain
                            @click="handleAdd"
                            v-hasPermi="['att:cat:atttaskcat:add']"
                            @mousedown="(e) => e.preventDefault()"
                        >
                ...
                <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                    <template #default="scope">
                        <el-button
                            ...
                            v-hasPermi="['att:cat:atttaskcat:edit']"
                            >修改</el-button
                        >
                        <el-button
                            link
                        ...
                        <el-button
                            ...
                            v-hasPermi="['att:cat:atttaskcat:remove']"
                            >删除</el-button
                        >
                    </template>
                </el-table-column>
...
<script setup name="AttTaskCat">
    import {
        ...
        addAttTaskCat,
        updateAttTaskCat
    } from '@/api/att/cat/attTaskCat/attTaskCat';
    ...
    function handleStatusChange(row) {
        ...
        proxy.$modal
            .confirm('确认要"' + text + '","' + row.name + '"任务类目吗？')
            .then(function () {
    ...
    function handleDelete(row) {
        ...
        proxy.$modal
            .confirm('是否确认删除任务类目管理编号为"' + _ids + '"的数据项？')
            .then(function () {
