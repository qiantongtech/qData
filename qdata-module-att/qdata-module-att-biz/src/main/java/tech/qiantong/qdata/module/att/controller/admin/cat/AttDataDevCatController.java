...
@Tag(name = "数据开发类目管理")
@RestController
@RequestMapping("/att/AttDataDevCat")
@Validated
public class AttDataDevCatController extends BaseController {
    ...
    @PreAuthorize("@ss.hasPermi('att:cat:attdatadevcat:export')")
    ...
    @PreAuthorize("@ss.hasPermi('att:cat:attdatadevcat:import')")
    ...
    @PreAuthorize("@ss.hasPermi('att:cat:attdatadevcat:query')")
    @GetMapping(value = "/{id}")
    ...
    @PreAuthorize("@ss.hasPermi('att:cat:attdatadevcat:add')")
    ...
    @PreAuthorize("@ss.hasPermi('att:cat:attdatadevcat:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('att:cat:attdatadevcat:remove')")
