...
function handleStatusChange(row) {
    ...
    proxy.$modal
        .confirm(td('att.common.confirmStatusChangeGeneric', '', { status: text, name: row.name, type: td('att.common.dataAssetCatName') }))
        .then(function () {
...
function handleDelete(row) {
    proxy.$modal
        .confirm(td('att.assetCat.messages.confirmDelete', '', { name: row.name }))
        .then(function () {
