        ...
        <el-row :gutter="10" class="btn-style">
          <el-col :span="1.5">
            <el-button
                ...
                icon="Plus"
                @click="handleAdd"
                v-hasPermi="['att:cat:assetcat:add']"
            >新增</el-button
            >
          </el-col>
          <el-col :span="1.5">
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template #default="scope">
            <el-button
                ...
                v-hasPermi="['att:cat:assetcat:edit']"
            >修改</el-button
            >
            <el-button
                link
            ...
            <el-button
                ...
                v-hasPermi="['att:cat:assetcat:remove']"
            >删除</el-button
            >
          </template>
        </el-table-column>
...
import {
  ...
  addAttQualityCat,
  updateAttQualityCat
} from '@/api/att/cat/attQualityCat/AttQualityCat.js';
import { listAttDataElemCat } from '@/api/att/cat/attDataElemCat/attDataElemCat.js';
