<template>
    ...
    <el-table stripe height="33.5vh" v-loading="loading" :data="dpDataElemAssetRelList"
        @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
        <el-table-column label="编号" align="center" prop="id" width="80" />
        <el-table-column label="资产名称" :show-overflow-tooltip="true" align="left" prop="assetName" width="300">
            <template #default="scope">
                {{ scope.row.assetName || '-' }}
            </template>
        </el-table-column>
        <el-table-column label="资产描述" :show-overflow-tooltip="true" align="left" prop="description" width="380">
            <template #default="scope">
...
} from '@/api/dp/dataElem/dpDataElemAssetRel';
