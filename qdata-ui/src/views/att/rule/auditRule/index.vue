  ...
  <div class="app-container" ref="app-container">
    ...
    <el-container style="90%">
      <DeptTree
        ...
        :leftWidth="leftWidth"
        :placeholder="t('att.rule.auditRule.ruleCategoryPlaceholder')"
      ...
      <el-main>
        <div class="pagecont-top" v-show="showSearch">
          ...
          >
            <!-- <el-form-item
              :label="t('att.rule.auditRule.ruleCategory')"
              prop="category"
            >
              <el-input
            ...
            <el-form-item :label="t('att.rule.auditRule.ruleName')" prop="name">
              <el-input
                v-model="queryParams.name"
                :placeholder="t('att.rule.auditRule.ruleNamePlaceholder')"
                clearable
                @keyup.enter="handleQuery"
              />
            </el-form-item>
            <el-form-item>
              <el-button type="primary" icon="Search" @click="handleQuery">{{
                t("att.rule.auditRule.search")
              }}</el-button>
              <el-button icon="Refresh" @click="resetQuery">{{
                t("att.rule.auditRule.reset")
              }}</el-button>
            </el-form-item>
          </el-form>
        </div>
        ...
        <div class="pagecont-bottom">
          ...
          >
            <el-table-column
              ...
              :label="t('att.rule.auditRule.code')"
              align="left"
              prop="code"
              width="80"
            >
            ...
            <el-table-column
              ...
              :label="t('att.rule.auditRule.ruleName')"
              align="left"
              prop="name"
            ...
            <el-table-column
              ...
              :label="t('att.rule.auditRule.qualityDimension')"
              align="left"
              prop="qualityDim"
              :show-overflow-tooltip="{ effect: 'light' }"
              width="80"
            ...
            <el-table-column
              ...
              :label="t('att.rule.auditRule.description')"
              width="400"
              align="left"
              prop="description"
            >
            ...
            <el-table-column
              ...
              :label="t('att.rule.auditRule.useCase')"
              width="500"
              align="left"
              prop="level"
              :show-overflow-tooltip="{ effect: 'light' }"
            ...
            <el-table-column
              ...
              :label="t('att.rule.auditRule.example')"
              width="700"
              align="left"
              prop="type"
              :show-overflow-tooltip="{ effect: 'light' }"
            ...
            <template #empty>
              <div class="emptyBg">
                <img
                  ...
                  alt=""
                />
                <p>{{ t("att.rule.auditRule.noData") }}</p>
              </div>
            </template>
          </el-table>
    ...
    >
      ...
      >
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item :label="t('att.rule.auditRule.code')" prop="code">
              <el-input
                v-model="form.code"
                :placeholder="t('att.rule.auditRule.codePlaceholder')"
              />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            ...
            >
              <el-select
                v-model="form.qualityDim"
                :placeholder="
                  t('att.rule.auditRule.qualityDimensionPlaceholder')
                "
              >
                <el-option
        ...
        <el-row :gutter="20">
          <el-col :span="24">
            <el-form-item
              :label="t('att.rule.auditRule.scenario')"
              prop="useCase"
            >
              <el-input
                type="textarea"
                v-model="form.useCase"
                :placeholder="t('att.rule.auditRule.scenarioPlaceholder')"
              />
            </el-form-item>
          </el-col>
        </el-row>
          ...
          <el-col :span="24">
            ...
            >
              <el-input
                ...
                :placeholder="t('att.rule.auditRule.examplePlaceholder')"
              />
            </el-form-item>
          </el-col>
        </el-row>
          ...
          <el-col :span="24">
            ...
            >
              <el-input
                ...
                :placeholder="t('att.rule.auditRule.descriptionPlaceholder')"
              />
            </el-form-item>
          </el-col>
        </el-row>
      ...
      <template #footer>
        <div class="dialog-footer">
          <el-button size="mini" @click="cancel">{{
            t("att.rule.auditRule.cancel")
          }}</el-button>
          <el-button type="primary" size="mini" @click="submitForm">{{
            t("att.rule.auditRule.confirm")
          }}</el-button>
        </div>
      </template>
    </el-dialog>
...
const formLabelWidth = computed(() =>
  locale.value === "zh-Hans" ? "75px" : "100px"
);
...
processedData.value = computed(() => {
  return [
    {
      name: t("att.rule.auditRule.qualityDimension"),
      id: "",
...
// 列显隐信息
const columns = ref([
  { key: 6, label: t("att.rule.auditRule.code"), visible: true },
  { key: 1, label: t("att.rule.auditRule.ruleName"), visible: true },
  { key: 2, label: t("att.rule.auditRule.qualityDimension"), visible: true },
  { key: 5, label: t("att.rule.auditRule.description"), visible: true },
  { key: 3, label: t("att.rule.auditRule.useCase"), visible: true },
  { key: 4, label: t("att.rule.auditRule.example"), visible: true },
]);
...
const data = reactive({
  ...
  rules: computed(() => ({
    name: [
      {
        required: true,
        message: t("att.rule.auditRule.ruleNameRequired"),
        trigger: "blur",
      },
    ],
    qualityDim: [
      {
        required: true,
        message: t("att.rule.auditRule.qualityDimensionRequired"),
        trigger: "change",
      },
    ],
    ...
    code: [
      {
        required: true,
        message: t("att.rule.auditRule.codeRequired"),
        trigger: "change",
      },
    ],
...
function handleAdd() {
  ...
  form.value.level = "1";
  open.value = true;
  title.value = t("att.rule.auditRule.addRule");
}
...
function handleUpdate(row) {
  ...
  getAttAuditRule(_id).then((response) => {
    ...
    open.value = true;
    title.value = t("att.rule.auditRule.editRule");
  });
}
...
function handleDetail(row) {
  ...
  getAttAuditRule(_id).then((response) => {
    ...
    title.value = t("att.rule.auditRule.ruleDetail");
  });
}
    ...
    if (valid) {
      if (form.value.id != null) {
        updateAttAuditRule(form.value)
          .then((response) => {
            proxy.$modal.msgSuccess(t("att.rule.auditRule.updateSuccess"));
            open.value = false;
            getList();
          })
          .catch((error) => {});
        ...
        addAttAuditRule(form.value)
          .then((response) => {
            proxy.$modal.msgSuccess(t("att.rule.auditRule.addSuccess"));
            open.value = false;
            getList();
          })
          .catch((error) => {});
...
function handleDelete(row) {
  ...
  proxy.$modal
    .confirm(t("att.rule.auditRule.deleteConfirm", { code: _ids }))
    .then(function () {
      return delAttAuditRule(_ids);
    })
    .then(() => {
      getList();
      proxy.$modal.msgSuccess(t("att.rule.auditRule.deleteSuccess"));
    })
    .catch(() => {});
}
...
const handleFileSuccess = (response, file, fileList) => {
  ...
  proxy.$alert(
    "<div style='overflow: auto;overflow-x: hidden;max-height: 70vh;padding: 10px 20px 0;'>" +
      response.msg +
      "</div>",
    t("att.rule.auditRule.importResult"),
