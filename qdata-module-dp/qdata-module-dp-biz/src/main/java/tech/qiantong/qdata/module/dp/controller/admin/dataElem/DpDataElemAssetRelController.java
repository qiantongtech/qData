...
@RestController
@RequestMapping("/dp/dpDataElemAssetRel")
@Validated
public class DpDataElemAssetRelController extends BaseController {
    ...
    @PreAuthorize("@ss.hasPermi('dp:dataElemAssetRel:dataelemassetrel:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('dp:dataElemAssetRel:dataelemassetrel:export')")
    ...
    @PreAuthorize("@ss.hasPermi('dp:dataElemAssetRel:dataelemassetrel:import')")
    ...
    @PreAuthorize("@ss.hasPermi('dp:dataElemAssetRel:dataelemassetrel:query')")
    @GetMapping(value = "/{id}")
    ...
    @PreAuthorize("@ss.hasPermi('dp:dataElemAssetRel:dataelemassetrel:add')")
    ...
    @PreAuthorize("@ss.hasPermi('dp:dataElemAssetRel:dataelemassetrel:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('dp:dataElemAssetRel:dataelemassetrel:remove')")
