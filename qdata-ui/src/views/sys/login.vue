    ...
    <div class="app-container login-two sysInfo sysInfo-wrap" ref="app-container">
        ...
        <div class="right-content">
            <div class="logo">
              ...
              >
                <img class="language-icon" src="@/assets/images/system/images/login/icon-language.svg" alt="" />
            ...
            <div>
                <div class="description">
                    <div class="contact" style="float: left">
                        <img src="@/assets/images/system/images/login/form-phone.png" />
                        <div>
                    ...
                    <div class="contact" style="margin-left: 24px">
                        <img src="@/assets/images/system/images/login/form-email.png" />
                        <div>
                ...
                <div class="chrome-wrap">
                    <img src="@/assets/images/system/images/login/img-goge-icon.png" style="height: 20px" />
                    ...
                    <a href="https://www.google.cn/chrome/" target="_blank">
                        <div style="
                                ...
                                align-items: center;
                            ">
                            <img id="window_img" src="@/assets/images/system/images/login/icon-window.svg"
                                style="height: 25px" />
                            <span style="
                                    color: #888;
                                    font-size: 12px;
                    ...
                    <a href="https://www.google.cn/chrome/" target="_blank">
                        <div style="
                                ...
                                align-items: center;
                            ">
                            <img id="mac_img" src="@/assets/images/system/images/login/icon-mac.svg" style="height: 25px" />
                            <span style="
                                    color: #888;
                                    font-size: 12px;
                                    line-height: 0;
...
import defaultLogo from '@/assets/images/system/images/login/logo-qdata.png';
