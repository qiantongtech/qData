...
public final class JSONUtils {
    ...
    public static List<Map<String, Object>> convertTaskDefinitionJson(String taskDefinitionJson) {
        return JSON.parseObject(taskDefinitionJson, List.class);
    }
    public static Map<String, Object> convertTaskDefinitionJsonMap(String taskDefinitionJson) {
        return JSON.parseObject(taskDefinitionJson, Map.class);
    }
    public static List<String> splitListByString(Object obj) {
