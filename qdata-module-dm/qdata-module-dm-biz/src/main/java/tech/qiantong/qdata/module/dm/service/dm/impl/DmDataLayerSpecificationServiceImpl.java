                ...
                if (isUpdateSupport) {
                    if (dmDataLayerSpecificationId != null) {
                        ...
                        if (existingDmDataLayerSpecification != null) {
                            ...
                            successNum++;
                            successMessages.add("数据更新成功，ID为 " + dmDataLayerSpecificationId + " 的数仓分层-规范管理记录。");
                        } else {
                            failureNum++;
                            failureMessages.add("数据更新失败，ID为 " + dmDataLayerSpecificationId + " 的数仓分层-规范管理记录不存在。");
                        }
                    } else {
                        failureNum++;
                    ...
                    if (existingDmDataLayerSpecification == null) {
                        ...
                        successNum++;
                        successMessages.add("数据插入成功，ID为 " + dmDataLayerSpecificationId + " 的数仓分层-规范管理记录。");
                    } else {
                        failureNum++;
                        failureMessages.add("数据插入失败，ID为 " + dmDataLayerSpecificationId + " 的数仓分层-规范管理记录已存在。");
                    }
                }
            } catch (Exception e) {
                failureNum++;
