...
@RestController
@RequestMapping("/dp/dpDataElemRuleRel")
@Validated
public class DpDataElemRuleRelController extends BaseController {
    ...
    @PreAuthorize("@ss.hasPermi('dp:dataElem:dataelemrulerel:export')")
    ...
    @PreAuthorize("@ss.hasPermi('dp:dataElem:dataelemrulerel:import')")
    ...
    @PreAuthorize("@ss.hasPermi('dp:dataElem:dataelemrulerel:query')")
    @GetMapping(value = "/{id}")
    ...
    @PreAuthorize("@ss.hasPermi('dp:dataElem:dataelemrulerel:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('dp:dataElem:dataelemrulerel:remove')")
