<template>
  <el-dialog title="数据集成任务-日志-多选" v-model="visible" width="1200px" :append-to="$refs['app-container']" draggable
...
<script setup name="DppEtlTaskLogMultiple">
...
function getList() {
  loading.value = true;
  listDppEtlTaskLog(proxy.addDateRange(queryParams.value, dateRange.value)).then(
    async (response) => {
