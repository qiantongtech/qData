...
public class DaAssetGisController extends BaseController {
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.gis:assetgis:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.gis:assetgis:export')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.gis:assetgis:import')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.gis:assetgis:query')")
    @GetMapping(value = "/{id}")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.gis:assetgis:add')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.gis:assetgis:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.gis:assetgis:remove')")
