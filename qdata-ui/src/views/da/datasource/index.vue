                ...
                <el-row :gutter="15" class="btn-style">
                    <el-col :span="1.5">
                        <el-button
                            ...
                            plain
                            @click="handleAdd"
                            v-hasPermi="['da:datasource:datasource:add']"
                            @mousedown="(e) => e.preventDefault()"
                        >
                ...
                >
                    <template #default="scope">
                        <el-button
                            ...
                            v-hasPermi="['da:datasource:datasource:edit']"
                            >测试连接</el-button
                        >
                        ...
                        <el-popover placement="bottom" :width="100" trigger="click">
                            ...
                            <div class="butgdlist">
                                ...
                                <el-button
                                    ...
                                    v-hasPermi="['da:datasource:datasource:remove']"
                                    >删除</el-button
                                >
                            </div>
                        </el-popover>
        ...
        >
            ...
            >
                <el-row :gutter="20">
                    ...
                    <el-col :span="12">
                        <el-form-item label="数据源类型" prop="datasourceType">
                            <el-select v-model="form.datasourceType" placeholder="请选择数据源类型" @change="handleDatasourceChange">
                                <el-option
                                    v-for="dict in datasource_type"
                                    :key="dict.value"
                                    :label="dict.label"
                ...
                <el-row
                    :gutter="20"
                    v-if="form.datasourceType !== null && form.datasourceType === 'Kafka'"
                >
                    <el-col :span="20">
                        <el-form-item label="配置参数" prop="config">
                            <el-input
                                ...
                                v-model="form.config"
                                placeholder='例如: {"security.protocol"&colon;"SASL_PLAINTEXT"}'
                            />
                        </el-form-item>
                    </el-col>
                </el-row>
