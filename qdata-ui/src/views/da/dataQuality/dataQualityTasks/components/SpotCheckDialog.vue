<template>
    <el-dialog v-model="visible" title="查看抽检结果" width="1000px" :before-close="handleClose">
        <el-tabs v-model="activeTab" @tab-click="handleTabClick">
            <el-tab-pane label="问题数据" name="problem">
                <el-table :data="problemData" height="600px" border v-loading="loading">
            ...
            <el-tab-pane label="正常数据" name="normal">
                <el-table :data="normalData" height="600px" border v-loading="loading">
                    <el-table-column v-for="col in tableColumns" :key="col.field" :prop="col.field" :min-width="'150px'"
                        show-overflow-tooltip align="center">
                        <template #header>
                            <div class="column-header">
...
import { validationErrorDataSql, validationValidDataSql } from '@/api/da/dppQuality/DppQualityTask'
