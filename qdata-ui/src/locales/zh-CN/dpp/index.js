...
export default {
  ...
  asset: {
    ...
    add: {
      ...
      assetInfoComplete: '资产信息完善',
      assetInfoHint:'明细表/汇总表/维度表需关联贴源层或公共层及其子层、业务分类和数据域；应用表自动关联数据应用层，需补充主题域。',
      batchSetting: '批量设置',
      batchSettingHint: '批量设置将覆盖所选行的已有值',
      tableType: '表类型',
      dataLayer: '数仓分层',
      dataLayerPlaceholder: '请选择数仓分层',
      dataLayerRequired: '请选择数仓分层',
      businessCategory: '业务分类',
      businessCategoryRequired: '请选择业务分类',
      dataDomain: '数据分域',
      dataDomainRequired: '请选择数据分域',
      themeDomain: '主题域',
      themeDomainPlaceholder: '请选择主题域',
      themeDomainRequired: '请选择主题域',
      tableCase: '表命名规范',
      tableCasePlaceholder: '请选择表命名规范',
      tableCaseRequired: '请选择表命名规范',
      table: {
        sourceTable: '来源表名',
        tableName: '表名',
  ...
  instance: {
    ...
    developTask: {
      ...
      recentExecutionTime: '最近执行时间',
      runDuration: '运行时长',
      runningNodes: '运行中节点',
      todayErrorNodes: '今日异常节点',
      todayExecutions: '今日执行',
      todaySuccessRate: '今日成功率',
      nodeUnit: '次',
      runningNodesTip: '当前正在运行的节点实例数',
      todayErrorNodesTip: '今日执行失败的节点实例数',
      todayExecutionsTip: '今日开始执行的节点实例数',
      todaySuccessRateTip: '今日成功节点实例数占今日已完成节点实例数的比例',
    },
    integratioTask: {
      id: '编号',
      taskInstanceName: '任务实例名称',
  ...
  developTask: {
    ...
    executeStatus: '执行状态',
    selectExecuteStatus: '请选择执行状态',
    executeTime: '执行时间',
    runningTasks: '正在运行任务',
    runningTasksTip: '至少有一个运行中实例的任务数量',
    todayErrorTasks: '今日异常任务',
    todayErrorTasksTip: '今日最近一次执行失败的任务数量',
    todayExecutions: '今日执行次数',
    todayExecutionsTip: '今日创建的执行实例数量',
    todaySuccessRate: '今日成功率',
    todaySuccessRateTip: '今日成功完成实例数占全部已完成实例数的比例',
    taskUnit: '次',
    noExecutionLog: '暂无最近执行日志',
    projectRequired: '所属项目不能为空',
    notExecuted: '未执行',
    configureTask: '配置任务',
    schedulePeriod: '调度周期',
    scheduler: '调度器',
  ...
  integratioTask: {
    ...
    runningTasksTip: '至少有一个运行中实例的任务数量',
    todayErrorTasks: '今日异常任务',
    todayErrorTasksTip: '最近一次执行失败的任务数量',
    todayExecutions: '今日执行次数',
    todayExecutionsTip: '今日创建的执行实例数量',
    todaySuccessRate: '今日成功率',
    todaySuccessRateTip: '今日成功完成实例数占全部已完成实例数的比例',
    taskUnit: '次',
    statsDeadline: '数据统计截止',
    running: '运行中',
    success: '成功',
    failed: '失败',
    idle: '空闲',
    currentRunningTasks: '当前运行中 {count} 个任务',
    currentNodeStage: '当前节点/阶段',
    startTime: '开始时间',
    runDuration: '运行时长',
    latestLog: '最新日志',
    noLogs: '暂无日志',
    viewRealTimeLog: '查看实时日志',
    viewInstance: '查看实例',
    loading: '加载中...',
    allDisplayed: '已显示全部{title}',
    noDataWithTitle: '暂无{title}',
    taskStarted: '任务开始执行',
    dataLoading: '数据加载中...',
    instanceSummaryPrefix: '实例统计：',
    summarySeparator: '个，',
    instanceCountUnit: '个实例',
    runningInstanceSuffix: '个实例运行中',
    successInstanceSuffix: '个实例成功',
    failedInstanceSuffix: '个实例失败',
    ...
    currentNode: '当前节点',
    operation: '操作',
    noRunningInstance: '没有找到运行中的任务实例。',
    fetchLatestRunningFailed: '获取最新运行中任务失败。',
    loadLogFailed: '日志加载失败，请稍后重试',
  ...
  integration: {
    ...
    constantDefaultValueTypeMismatch: '默认值与字段类型不一致，请修改。',
    constantFieldNameConflictsUpstream: '常量字段名称与上游字段重复。',
    ...
    ignoreCase: '忽略大小写',
    derivedFieldNameDuplicate: '新增字段名称已存在，请更换其他名称。',
    ignoreCaseSensitiveFieldWarning: '该字段可能大小写敏感，忽略大小写可能误删记录。',
    fetchFields: '获取字段',
    ...
    fieldAliasRequired: '字段别名不能为空。',
    fieldAliasDuplicate: '请不要填写重复的字段别名。',
    fieldAliasExistingField: '字段别名与已有字段名称重复。',
    fieldAliasInvalid: '字段别名包含非法字符。',
    fieldTypeIncompatible: '所选字段类型与源字段类型不兼容。',
    fieldLengthUnsupported: '当前字段类型不支持配置长度。',
    fieldLengthPositiveInteger: '字段长度必须为正整数。',
    fieldPrecisionUnsupported: '当前字段类型不支持配置精度。',
    fieldPrecisionNonNegativeInteger: '字段精度必须为非负整数。',
    fieldPrecisionExceedsLength: '字段精度不能大于字段长度。',
