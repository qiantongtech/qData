...
@Tag(name = "数据资产申请")
@RestController
@RequestMapping("/da/daAssetApply")
@Validated
public class DaAssetApplyController extends BaseController {
    ...
    @PreAuthorize("@ss.hasPermi('da:daAssetApply:daassetapply:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('da:daAssetApply:daassetapply:export')")
    ...
    @PreAuthorize("@ss.hasPermi('da:daAssetApply:daassetapply:import')")
    ...
    @PreAuthorize("@ss.hasPermi('da:daAssetApply:daassetapply:query')")
    @GetMapping(value = "/{id}")
    ...
    @PreAuthorize("@ss.hasAnyPermi('da:daAssetApply:daassetapply:add,da:asset:asset:add')")
    ...
    @PreAuthorize("@ss.hasPermi('da:daAssetApply:daassetapply:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('da:daAssetApply:daassetapply:remove')")
