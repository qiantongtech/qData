                ...
                if (isUpdateSupport) {
                    if (dgDataCategoryId != null) {
                        ...
                        if (existingDgDataCategory != null) {
                            ...
                            successNum++;
                            successMessages.add("数据更新成功，ID为 " + dgDataCategoryId + " 的数据分类记录。");
                        } else {
                            failureNum++;
                            failureMessages.add("数据更新失败，ID为 " + dgDataCategoryId + " 的数据分类记录不存在。");
                        }
                    } else {
                        failureNum++;
                    ...
                    if (existingDgDataCategory == null) {
                        ...
                        successNum++;
                        successMessages.add("数据插入成功，ID为 " + dgDataCategoryId + " 的数据分类记录。");
                    } else {
                        failureNum++;
                        failureMessages.add("数据插入失败，ID为 " + dgDataCategoryId + " 的数据分类记录已存在。");
                    }
                }
            } catch (Exception e) {
                failureNum++;
