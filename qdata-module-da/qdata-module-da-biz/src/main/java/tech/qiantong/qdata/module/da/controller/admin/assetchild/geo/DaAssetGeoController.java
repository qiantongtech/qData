...
public class DaAssetGeoController extends BaseController {
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.geo:assetgeo:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.geo:assetgeo:export')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.geo:assetgeo:import')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.geo:assetgeo:query')")
    @GetMapping(value = "/{id}")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.geo:assetgeo:add')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.geo:assetgeo:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.geo:assetgeo:remove')")
