...
export default {
  license: {
    ...
    text: {
      intro: [
        'qData は Apache License 2.0 に基づき提供されており、以下の qData 固有の追加条件が適用されます：',
        '本ライセンスにおいて「qData」とは、フロントエンド、バックエンド、API、および関連文書を含む、ソフトウェアプロジェクト全体またはその一部を指します。',
        '本ライセンスにおいて「製作者」とは、江蘇千桐科技有限公司を指します。'
      ],
      terms: [
        {
          title: 'qData に表示されるロゴ、著作権表示、ライセンス表示、または帰属情報を削除、非表示、または改変しない限り、qData を商用目的で使用することができます。',
          desc: [
      ...
      notice: {
        before: '上記の特定の条件を除き、その他のすべての権利と制限は Apache License 2.0 に従います。Apache License 2.0 の詳細については、',
