...
/**
 * Data Development Category Management Request VO ATT_DATA_DEV_CAT
 *
 * @author qdata
 * @date 2025-03-11
 */
@Schema(description = "数据开发类目管理 Request VO")
@Data
public class AttDataDevCatPageReqVO extends PageParam {
