...
@Tag(name = "数据集成任务节点关系")
@RestController
@RequestMapping("/dpp/dppEtlTaskNodeRel")
@Validated
public class DppEtlTaskNodeRelController extends BaseController {
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etltasknoderel:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etltasknoderel:export')")
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etltasknoderel:import')")
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etltasknoderel:query')")
    @GetMapping(value = "/{id}")
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etltasknoderel:add')")
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etltasknoderel:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etltasknoderel:remove')")
