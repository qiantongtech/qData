                ...
                <el-row :gutter="15" class="btn-style">
                    <el-col :span="1.5">
                        <el-button
                            ...
                            plain
                            @click="handleAdd"
                            v-hasPermi="['att:cat:attapicat:add']"
                            @mousedown="(e) => e.preventDefault()"
                        >
                ...
                <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                    <template #default="scope">
                        <el-button
                            ...
                            v-hasPermi="['att:cat:attapicat:edit']"
                            >修改</el-button
                        >
                        <el-button
                            link
                        ...
                        <el-button
                            ...
                            v-hasPermi="['att:cat:attapicat:remove']"
                            >删除</el-button
                        >
                    </template>
                </el-table-column>
...
<script setup name="AttApiCat">
    import {
        ...
        addAttApiCat,
        updateAttApiCat
    } from '@/api/att/cat/attApiCat/attApiCat';
    ...
    const data = reactive({
        ...
        rules: {
            name: [{ required: true, message: '数据服务类目名称不能为空', trigger: 'blur' }],
    ...
    function handleDelete(row) {
        ...
        proxy.$modal
            .confirm('是否确认删除API类目管理编号为"' + _ids + '"的数据项？')
            .then(function () {
