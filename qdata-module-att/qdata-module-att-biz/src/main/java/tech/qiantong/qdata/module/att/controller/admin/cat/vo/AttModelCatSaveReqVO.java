...
/**
 * Logical Model Category Management Create/Update Request VO ATT_MODEL_CAT
 *
 * @author qdata
 * @date 2025-01-20
 */
@Schema(description = "逻辑模型类目管理 Response VO")
@Data
public class AttModelCatSaveReqVO extends BaseEntity {
