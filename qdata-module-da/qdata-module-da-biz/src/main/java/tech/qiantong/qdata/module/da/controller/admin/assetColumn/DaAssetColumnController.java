...
@Tag(name = "数据资产字段")
@RestController
@RequestMapping("/da/daAssetColumn")
@Validated
public class DaAssetColumnController extends BaseController {
    ...
    @PreAuthorize("@ss.hasPermi('da:assetColumn:assetcolumn:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetColumn:assetcolumn:export')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetColumn:assetcolumn:import')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetColumn:assetcolumn:query')")
    @GetMapping(value = "/{id}")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetColumn:assetcolumn:add')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetColumn:assetcolumn:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetColumn:assetcolumn:remove')")
