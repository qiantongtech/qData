        ...
        <div class="quality-header" v-if="taskData.id">
            <div class="quality-info">
                ...
                <div class="quality-item">
                    ...
                    <span class="quality-value"> {{ parseTime(taskData.lastExecuteTime, '{y}-{m}-{d} {h}:{i}:{s}') || '-'
                        }}</span>
                </div>
            </div>
            ...
            <el-row>
                <div class="module-8 border-item" style="width: 100%">
                    ...
                    <div class="border-item-body" style="height: 320px;">
                        <el-table stripe height="300px" v-loading="loading" :data="ruleList" lazy show-overflow-tooltip>
                            ...
                            <el-table-column v-if="getColumnVisibility(3)" label="质量维度" align="center"
                                prop="dimensionType" show-overflow-tooltip>
                                <template #default="scope">
                            ...
                            <el-table-column v-if="getColumnVisibility(7)" label="问题数据量占比" align="center"
                                prop="proportion" show-overflow-tooltip>
                                <template #default="scope">
                                    {{
...
import QualityTaskDialog from './components/QualityTaskDialog.vue';
import ProblemDialog from '../../../../views/da/dataQuality/dataQualityTaskLogs/components/ProblemDialog.vue';

import {
    statisticsEvaluateOne,
    statisticsEvaluateTow,
    statisticsEvaluateTable
} from "@/api/da/dppQuality/DppQualityLog";
import {
    listDppQualityTask,
    delDppQualityTask,
