        ...
        <div class="flex-row">
            ...
            <div class="content-col" v-loading="loading">
                ...
                <el-table :data="dpDataElemList" stripe @row-click="handleRowClick" :highlight-current-row="true"
                    ...
                    <el-table-column v-if="getColumnVisibility(1)" label="中文名称" :show-overflow-tooltip="true" width="80"
                        align="left" prop="name">
                        <template #default="scope">{{ scope.row.name || "-" }}</template>
                    </el-table-column>
                    <el-table-column v-if="getColumnVisibility(2)" label="英文名称" :show-overflow-tooltip="true" width="80"
                        align="left" prop="engName">
                        <template #default="scope">{{ scope.row.engName || "-" }}</template>
                    </el-table-column>
                    <el-table-column v-if="getColumnVisibility(3)" label="类型" align="center" prop="type">
                    ...
                    <el-table-column v-if="getColumnVisibility(6)" width="140" label="元描述" align="left"
                        prop="description" :show-overflow-tooltip="true">
