  ...
  <div class="app-container" ref="app-container">
    ...
    <div class="pagecont-bottom">
        ...
        <el-row :gutter="10" class="btn-style">
          <el-col :span="1.5">
            <el-button type="primary" plain icon="Plus" @click="handleAdd"
              v-hasPermi="['att:cat:assetcat:add']">新增</el-button>
          </el-col>
          <el-col :span="1.5">
      ...
      <el-table height="60vh" v-if="refreshTable" v-loading="loading" :data="AttCleanCatList" row-key="id"
        ...
        <!--                        </template>-->
        <!--                      </el-table-column>-->
        <el-table-column label="清洗规则类目名称" align="left" prop="name" width="400" show-overflow-tooltip>
          <template #default="scope">
            {{ scope.row.name || '-' }}
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template #default="scope">
            <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
              v-hasPermi="['att:cat:assetcat:edit']">修改</el-button>
            <el-button link type="primary" icon="Plus" @click="handleAdd(scope.row)"
              v-hasPermi="['att:cat:assetcat:add']">新增</el-button>
            <el-button link type="danger" icon="Delete" @click="handleDelete(scope.row)"
              v-hasPermi="['att:cat:assetcat:remove']">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
...
<script setup name="attCleanCat">
import { listAttCleanCat, getAttCleanCat, delAttCleanCat, addAttCleanCat, updateAttCleanCat } from "@/api/att/cat/attCleanCat/attCleanCat.js";
