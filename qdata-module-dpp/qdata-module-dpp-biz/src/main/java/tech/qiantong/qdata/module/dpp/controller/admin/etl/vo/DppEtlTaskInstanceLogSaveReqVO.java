...
/**
 * Data Integration Task Instance-Log Create/Update Request VO DPP_ETL_TASK_INSTANCE_LOG
 *
 * @author qdata
 * @date 2025-08-05
 */
@Schema(description = "Data Integration Task Instance-Log Create/Update Request VO")
@Data
