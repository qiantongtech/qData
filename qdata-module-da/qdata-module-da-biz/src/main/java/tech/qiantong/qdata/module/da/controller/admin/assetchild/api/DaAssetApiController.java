...
public class DaAssetApiController extends BaseController {
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.api:api:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.api:api:export')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.api:api:import')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.api:api:query')")
    @GetMapping(value = "/{id}")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.api:api:add')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.api:api:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.api:api:remove')")
