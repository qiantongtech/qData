        ...
        <div class="pagecont-bottom">
            <div class="justify-between mb15">
                <el-row :gutter="15" class="btn-style">
                    <el-col :span="1.5">
                        <el-button type="primary" plain @click="handleAdd" v-hasPermi="['att:cat:attdatadevcat:add']"
            ...
            <el-table height="60vh" v-if="refreshTable" v-loading="loading" :data="AttDataDevCatList" row-key="id"
                ...
                <el-table-column label="数据开发类目名称" align="left" prop="name" width="400" :show-overflow-tooltip="{effect: 'light'}">
                ...
                <el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right"
                    ...
                    <template #default="scope">
                        <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                            v-hasPermi="['att:cat:attdatadevcat:edit']">修改</el-button>
                        <el-button link type="primary" icon="Plus" @click="handleAdd(scope.row)"
                            v-hasPermi="['att:cat:attdatadevcat:add']">新增</el-button>
                        <el-button link type="danger" icon="Delete" @click="handleDelete(scope.row)"
                            v-hasPermi="['att:cat:attdatadevcat:remove']">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
...
<script setup name="AttDataDevCat">
import {
    listAttDataDevCat,
    getAttDataDevCat,
    delAttDataDevCat,
    addAttDataDevCat,
    updateAttDataDevCat
} from '@/api/att/cat/attDataDevCat/attDataDevCat';
