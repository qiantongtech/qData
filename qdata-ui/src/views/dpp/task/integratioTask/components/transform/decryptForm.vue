    ...
    <el-dialog v-model="visibleDialog" :draggable="true" class="medium-dialog" :title="currentNode?.data?.name"
        ...
        <template #header>
            <div class="justify">
                ...
                <el-tooltip effect="light" content="用于解密指定字段，恢复加密前的数据" placement="top">
            ...
            <el-row :gutter="20">
                ...
                <el-col :span="12">
                    <el-form-item label="密文字段" prop="taskParams.encryptedField"
                        :rules="[{ required: true, message: '请选择密文字段', trigger: 'change' }]">
                        <el-select v-model="form.taskParams.encryptedField" placeholder="请选择密文字段" style="width: 100%">
                ...
                <el-col :span="12">
                    <el-form-item label="明文字段" prop="taskParams.plaintextField"
                        :rules="[{ required: true, message: '请输入明文字段', trigger: 'change' }]">
                        <template #label>
                            <div class="justify-center">
                                <span>明文字段</span>
                        ...
                        <el-input v-model="form.taskParams.plaintextField" placeholder="请输入明文字段" style="width: 100%" />
                    </el-form-item>
                </el-col>
            </el-row>
...
const saveData = async () => {
    try {
        ...
        taskParams.outputFields = [
            ...inputFields.value,
            {
                columnName: form.value?.taskParams.plaintextField,
