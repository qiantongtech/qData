...
@Tag(name = "数据质量任务")
@RestController
@RequestMapping("/dpp/DppQualityTask")
@Validated
public class DppQualityTaskController extends BaseController {
    ...
    public AjaxResult updateDaDiscoveryTaskStatus(@RequestBody DppQualityTaskSaveReqVO daDiscoveryTask) throws SchedulerException
    {
    ...
    public AjaxResult updateDaDiscoveryTaskCronExpression(@RequestBody DppQualityTaskSaveReqVO daDiscoveryTask) throws SchedulerException
    {
