...
<template>
  ...
  <div class="pagecont-bottom">
    ...
    <el-table stripe v-loading="loading" :data="AttProjectUserRelList" @selection-change="handleSelectionChange"
      ...
      <el-table-column :label="t('common.texts.number')" width="80" align="center" prop="userId">
      ...
      <el-table-column v-if="getColumnVisibility(14)" :label="t('common.texts.createdTime')" align="center" prop="create_time" width="150"
      ...
      <el-table-column :label="t('common.texts.operation')" align="center" class-name="small-padding fixed-width" fixed="right" width="240">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
            v-hasPermi="['att:projectUserRel:edit']">{{ t('common.button.update') }}</el-button>
  ...
  <el-dialog title="用户选择" v-model="openTwo" width="1000px" class="user-select-tatble" draggable>
    ...
    <el-table ref="userTableRef" stripe v-loading="loadingUser" :data="userList"
      ...
      <el-table-column :label="t('common.texts.number')" width="80" align="center" key="userId" prop="userId" />
      ...
      <el-table-column :label="t('common.texts.createdBy')" :show-overflow-tooltip="true" align="left" prop="createBy">
        <template #default="scope">
          {{ scope.row.createBy || "-" }}
        </template>
      </el-table-column>
      <el-table-column :label="t('common.texts.createdTime')" align="center" prop="createTime" width="150"> <template #default="scope"> <span>{{
    ...
    <template #footer>
      <div class="dialog-footer">
        <el-button size="mini" @click="openTwo = false">{{ t('common.button.cancel') }}</el-button>
        <el-button type="primary" size="mini" @click="submitFormUser">{{ t('common.button.confirm') }}</el-button>
      </div>
    </template>
  </el-dialog>
</template>
