...
@Tag(name = "资产稽查调度")
@RestController
@RequestMapping("/da/daAssetAuditSchedule")
@Validated
public class DaAssetAuditScheduleController extends BaseController {
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.audit:assetauditschedule:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.audit:assetauditschedule:export')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.audit:assetauditschedule:import')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.audit:assetauditschedule:query')")
    @GetMapping(value = "/{id}")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.audit:assetauditschedule:add')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.audit:assetauditschedule:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.audit:assetauditschedule:remove')")
