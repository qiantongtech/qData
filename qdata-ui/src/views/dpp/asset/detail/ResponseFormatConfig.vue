            ...
            <el-form :model="{ outputList }" :rules="rules" ref="headerForm" label-width="0">
                <el-row :gutter="24" class="mb8">
                    <el-table :data="outputList" class="tableStyle" row-key="id" border default-expand-all
                        ...
                        <el-table-column label="键" fixed="left" align="center" prop="name"
                            :show-overflow-tooltip="true">
                            <template #default="{ row, $index }">
                                <!-- <el-form-item :prop="`outputList[${findPosi(outputList, row.id)}].name`"
                                                    :rules="rules.name">
                        ...
                        <el-table-column label="值" fixed="left" align="center" prop="defaultValue"
                            :show-overflow-tooltip="true">
                            <template #default="{ row, $index }">
                                <el-form-item
                                    :prop="`outputList[${findPosi(outputList, row.dataSculptor)}].defaultValue`"
