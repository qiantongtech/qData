<template>
    <div class="app-container">
        ...
        <div class="body-wrapper">
            ...
            <el-row>
                <el-col :span="24">
                    <el-table class="tableStyle" :data="form.reqParams" stripe border :max-height="250"
            ...
            <el-row>
                <el-col :span="24">
                    <div v-if="apiExecuting">
                        ...
                        <el-pagination v-if="form.resDataType == '1'" :page-sizes="[10, 20, 50, 100]"
                            layout="total, sizes, prev, pager, next, jumper" :current-page.sync="callData.pageNum"
                            :page-size.sync="callData.pageSize" :total="callData.dataTotal"
...
<script setup>
import { serviceTesting } from '@/api/ds/api/dsApi.js';
...
function handleCall() {
    console.log('handleCall', props.form.reqParams);
    let isNull = false;
    props.form.reqParams.forEach((param) => {
        if (
            ...
            (param.paramValue == null ||
                ...
                param.paramValue == '' ||
                isNaN(param.paramValue))
        ) {
            proxy.$message.error('输入参数‘' + param.paramName + '’不能为空');
            isNull = true;
            return;
        }
    });
