...
export default {
  license: {
    ...
    text: {
      intro: [
        'qData 依据 Apache License 2.0 提供，并受以下针对 qData 的特定附加条件约束：',
        '在本协议中，“qData” 是指整个软件项目，包括但不限于其前端、后端、API 及相关文档的全部或部分内容。',
        '在本协议中，“制作方” 是指江苏千桐科技有限公司。'
      ],
      terms: [
        {
          title: '您可以将 qData 用于商业目的，但不得移除、隐藏或修改 qData 中显示的 qData 标识、版权声明、许可声明或归属信息。',
          desc: [
      ...
      notice: {
        before: '除上述特定条件外，其他所有权利和限制均遵循 Apache License 2.0 协议。有关 Apache License 2.0 的详细信息，请访问 ',
