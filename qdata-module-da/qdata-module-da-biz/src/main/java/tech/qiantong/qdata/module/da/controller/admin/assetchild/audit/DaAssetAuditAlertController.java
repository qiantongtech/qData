...
@Tag(name = "数据资产-质量预警")
@RestController
@RequestMapping("/da/daAssetAuditAlert")
@Validated
public class DaAssetAuditAlertController extends BaseController {
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.audit:assetauditalert:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.audit:assetauditalert:export')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.audit:assetauditalert:import')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.audit:assetauditalert:query')")
    @GetMapping(value = "/{id}")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.audit:assetauditalert:add')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.audit:assetauditalert:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.audit:assetauditalert:remove')")
