    ...
    <div class="app-container" ref="app-container">
        ...
        <div class="pagecont-bottom">
                ...
                <el-row :gutter="15" class="btn-style">
                    <el-col :span="1.5">
                        <el-button
                            ...
                            plain
                            @click="handleAdd"
                            v-hasPermi="['att:project:project:add']"
                            @mousedown="(e) => e.preventDefault()"
                        >
                    ...
                    <el-col :span="1.5">
                        <el-button
                            ...
                            :disabled="single"
                            @click="handleUpdate"
                            v-hasPermi="['att:project:project:edit']"
                            @mousedown="(e) => e.preventDefault()"
                        >
                    ...
                    <el-col :span="1.5">
                        <el-button
                            ...
                            :disabled="multiple"
                            @click="handleDelete"
                            v-hasPermi="['att:project:project:remove']"
                            @mousedown="(e) => e.preventDefault()"
                        >
            ...
            >
                ...
                <el-table-column label="项目名称" align="left" prop="name" width="200">
                    <template #default="scope">
                        {{ scope.row.name || '-' }}
                    </template>
                </el-table-column>
                ...
                <el-table-column label="联系方式" align="center" prop="managerPhone" width="140">
                    <template #default="scope">
                        {{ scope.row.managerPhone || '-' }}
                    </template>
                </el-table-column>

                <el-table-column label="状态" align="center" prop="validFlag" width="100">
                    <template #default="scope">
...
<script setup name="AttProject">
    import {
        ...
        updateAttProject,
        editProjectStatus
    } from '@/api/att/project/attProject';
    ...
    const columns = ref([
        ...
        { key: 2, label: '项目管理员id', visible: true },
