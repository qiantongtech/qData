...
export default {
  ...
  dataCode: {
    ...
    nameEnPattern: '只能包含英文字母和下划线',
    catCode: '代码表类目',
    catCodePlaceholder: '请选择代码表类目',
    catCodeRequired: '代码表类目不能为空',
    columnType: '字段类型',
    columnTypePlaceholder: '请选择字段类型',
    columnTypeRequired: '字段类型不能为空',
    documentType: '标准类型',
    ...
    addTitle: '新增代码表',
    editTitle: '修改代码表',
    confirmDelete: '是否确认删除代码表编号为"{id}"的数据项？',
    enableText: '启用',
    disableText: '禁用',
    confirmStatusChange: '确认要"{text}","{name}"代码表吗？',
    importTitle: '代码表导入',
    importResult: '导入结果',
    treeRootName: '代码表类目',
    selectToDeleteWarning: '未选择要删除的代码表规则关联信息，请选择后重试',
    codeValue: '代码值',
    codeValuePlaceholder: '请输入代码值',
    codeValueRequired: '代码值不能为空',
    codeValueDuplicate: '代码值已存在',
    ...
    addCodeTitle: '新增代码',
    editCodeTitle: '修改代码',
    confirmDeleteCode: '是否确认删除代码编号为"{id}"的数据项？',
    codeDict: {
      serialNumber: '编号',
      createBy: '创建人',
      createTime: '创建时间',
    ...
    originalValueRequired: '原始值不能为空',
    codeNameSelect: '请选择代码名',
    addCodeMapTitle: '新增代码映射',
    editCodeMapTitle: '修改代码映射',
    confirmDeleteCodeMap: '是否确认删除代码映射编号为"{id}"的数据项？',
    codeMap: {
      serialNumber: '编号',
      codeName: '代码名',
      codeValue: '代码值',
    ...
    confirmDeleteAsset: '是否确认删除代码表数据资产关联信息编号为"{id}"的数据项？',
    asset: {
      id: '编号',
      assetName: '资产名称',
      description: '描述',
      ...
      createTime: '创建时间',
      updateTime: '更新时间',
      addTitle: '新增代码表数据资产关联信息',
      editTitle: '修改代码表数据资产关联信息',
      detailTitle: '代码表数据资产关联信息详情',
      updateSuccess: '修改成功',
      addSuccess: '新增成功'
    },
    detail: {
