...
@Tag(name = "数据源与项目关联关系")
@RestController
@RequestMapping("/da/daDatasourceProjectRel")
@Validated
public class DaDatasourceProjectRelController extends BaseController {
    ...
    @PreAuthorize("@ss.hasPermi('da:datasource:datasourceprojectrel:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('da:datasource:datasourceprojectrel:export')")
    ...
    @PreAuthorize("@ss.hasPermi('da:datasource:datasourceprojectrel:import')")
    ...
    @PreAuthorize("@ss.hasPermi('da:datasource:datasourceprojectrel:query')")
    @GetMapping(value = "/{id}")
    ...
    @PreAuthorize("@ss.hasPermi('da:datasource:datasourceprojectrel:add')")
    ...
    @PreAuthorize("@ss.hasPermi('da:datasource:datasourceprojectrel:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('da:datasource:datasourceprojectrel:remove')")
