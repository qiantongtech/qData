    ...
    <el-form :model="{ headerList }" :rules="rules" ref="headerForm" label-width="0">
      <el-row :gutter="24" class="mb8">
        ...
        <el-table :data="headerList" row-key="id" border default-expand-all
          ...
          <el-table-column label="键" fixed="left" align="center" prop="name" :show-overflow-tooltip="true">
          ...
          <el-table-column label="值" fixed="left" align="center" prop="defaultValue" :show-overflow-tooltip="true">
            <template #default="{ row, $index }">
    ...
    <el-form :model="{ inputList }" :rules="rules" ref="inputForm" label-width="0">
      <el-row :gutter="24" class="mb8">
        ...
        <el-table :data="inputList" class="tableStyle" row-key="id" border default-expand-all
          ...
          <el-table-column label="是否为空" fixed="left" align="center" prop="requestFlag" :show-overflow-tooltip="true">
            <template #default="{ row, $index }">
          ...
          <el-table-column label="示例值" fixed="left" align="center" prop="exampleValue" :show-overflow-tooltip="true">
            <template #default="{ row, $index }">
          ...
          <el-table-column label="默认值" fixed="left" align="center" prop="defaultValue" :show-overflow-tooltip="true">
            <template #default="{ row, $index }">
