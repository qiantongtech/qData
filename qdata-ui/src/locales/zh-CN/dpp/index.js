...
export default {
  ...
  developTask: {
    ...
    oracle: 'Oracle',
    mysql: 'MySQL',
    taskNameDescription: '任务唯一标识，用于检索和区分任务',
    taskCategoryDescription: '任务所属开发类目，用于分类管理',
    responsiblePersonDescription: '任务维护责任人，用于异常跟进和追溯',
    contactNumberDescription: '责任人联系电话，随责任人自动带出',
    taskStatusDescription: '控制任务是否处于可运行状态',
    descriptionDescription: '记录任务用途和业务说明',
  ...
  integratioTask: {
    ...
    taskNameDescription: '任务唯一标识，用于检索和区分任务',
    taskCategoryDescription: '任务所属分类，用于分类管理',
    responsiblePersonDescription: '任务维护责任人，用于异常跟进和追溯',
    contactNumberDescription: '责任人联系电话，随责任人自动带出',
    taskStatusDescription: '控制任务是否处于可运行状态',
    descriptionDescription: '记录任务目标、数据来源和业务用途',
