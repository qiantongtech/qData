...
@Tag(name = "数据集成任务-日志")
@RestController
@RequestMapping("/dpp/dppEtlTaskLog")
@Validated
public class DppEtlTaskLogController extends BaseController {
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etltasklog:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etltasklog:export')")
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etltasklog:import')")
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etltasklog:query')")
    @GetMapping(value = "/{id}")
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etltasklog:add')")
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etltasklog:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('dpp:etl:etltasklog:remove')")
