    ...
    <el-container style="90%">
      ...
      <el-main>
        ...
        <div class="pagecont-bottom pagecont-bottoms">
          ...
          <el-table stripe height="58vh" v-loading="loading" :data="daAssetApplyList"
            ...
            <el-table-column v-if="getColumnVisibility(2)" label="英文名称" align="left" prop="assetTableName"
              :show-overflow-tooltip="true">
              <template #default="scope">
            ...
            <el-table-column v-if="getColumnVisibility(5)" label="申请项目" align="left" prop="projectName" width="120"
              :show-overflow-tooltip="true">
              <template #default="scope">
            ...
            <el-table-column v-if="getColumnVisibility(8)" label="更新时间" align="center" prop="updateTime" width="160"
              :show-overflow-tooltip="true">
              <template #default="scope">
                <span>{{
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right" width="140">
              <template #default="scope">
                <el-button link v-if="scope.row.status == 1" type="primary" icon="Stamp"
                  @click="handleUpdate(scope.row)" v-hasPermi="['da:daAssetApply:daassetapply:edit']">审核</el-button>
                <el-button link type="primary" icon="view" @click="handleDetail(scope.row)"
                  v-hasPermi="['da:daAssetApply:daassetapply:edit']">详情</el-button>
              </template>
            </el-table-column>
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="英文名称">
              <el-input v-model="form.assetTableName" disabled />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="主题名称">
              <el-input v-model="form.themeName" disabled />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="数据连接">
              <el-input v-model="form.datasourceName" disabled />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="数据库地址">
              <el-input v-model="form.datasourceIp" disabled />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="数据库类型">
              <el-input v-model="form.datasourceType" disabled />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="24">
            <el-form-item label="资产描述">
              <el-input type="textarea" v-model="form.description" :rows="3" disabled />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="申请项目" prop="projectCode">
              <el-select v-model="form.projectCode" @change="handleSelectProject" placeholder="请选择申请项目" disabled>
          ...
          <el-col :span="12">
            <el-form-item label="联系电话" prop="phonenumber">
              <el-input v-model="form.phonenumber" placeholder="请输入联系电话" disabled />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="24">
            <el-form-item label="申请事由" prop="applyReason">
              <el-input type="textarea" v-model="form.applyReason" :rows="3" placeholder="请输入申请事由" disabled />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
...
import {
  ...
  addDaAssetApply,
  updateDaAssetApply,
} from "@/api/da/daAssetApply/daAssetApply";
import { listAttProject } from "@/api/att/project/attProject";
