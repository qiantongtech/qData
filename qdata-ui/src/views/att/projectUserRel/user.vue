<template>
    ...
    <div class="pagecont-bottom">
            ...
            <el-row :gutter="15" class="btn-style">
                <el-col :span="1.5">
                    <el-button type="primary" plain @click="handleAdd"
                        v-hasPermi="['att:project:attprojectuserrel:add']" @mousedown="(e) => e.preventDefault()">
                        <i class="iconfont-mini icon-xinzeng mr5"></i>新增
                    </el-button>
                </el-col>
                <el-col :span="1.5">
                    <el-button type="danger" plain :disabled="multiple" @click="handleDelete"
                        v-hasPermi="['att:project:attprojectuserrel:remove']" @mousedown="(e) => e.preventDefault()">
        ...
        <el-table stripe height="55vh" v-loading="loading" :data="AttProjectUserRelList"
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right" width="240">
                <template #default="scope">
                    <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                        v-hasPermi="['att:project:attprojectuserrel:edit']">修改</el-button>
                    <el-button link type="danger" icon="Delete" @click="handleDelete(scope.row)"
                        v-hasPermi="['att:project:attprojectuserrel:remove']">移除</el-button>
                </template>
            </el-table-column>
    ...
    <!-- 新增或修改项目与用户关联关系对话框 -->
    <el-dialog :title="title" v-model="open" :append-to-body="false" class="warn-dialog-23012" width="600px"
    ...
    <el-dialog title="用户选择" v-model="openTwo" width="1000px" draggable>
        <template>
        ...
        <el-form class="btn-style" :model="queryParamsUser" ref="queryRef" :inline="true" label-width="68px">
            <el-form-item label="用户名称" prop="userName">
                <el-input v-model="queryParamsUser.userName" placeholder="请输入用户名称" clearable class="el-form-input-width"
                    @keyup.enter="handleQueryUser" />
            </el-form-item>
            <el-form-item label="手机号码" prop="phonenumber">
                <el-input v-model="queryParamsUser.phonenumber" placeholder="请输入手机号码" clearable
                    class="el-form-input-width" @keyup.enter="handleQueryUser" />
            </el-form-item>
            <el-form-item>
...
import { addUserAndProject, noProjectUser } from '@/api/att/project/attProject';
import { ref } from 'vue';
...
function handleDelete(row) {
    ...
    proxy.$modal
        .confirm('是否确认移除用户编号为"' + _userId + '"的数据项？')
        .then(function () {
