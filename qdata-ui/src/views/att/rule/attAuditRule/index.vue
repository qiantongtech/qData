...
<script setup name="AttAuditRule">
import {
    listAttAuditRule,
    getAttAuditRule,
    delAttAuditRule,
    addAttAuditRule,
    updateAttAuditRule
} from '@/api/att/rule/attAuditRule.js';
...
const upload = reactive({
    ...
    // 上传的地址
    url: import.meta.env.VITE_APP_BASE_API + '/att/attAuditRule/importData'
});
