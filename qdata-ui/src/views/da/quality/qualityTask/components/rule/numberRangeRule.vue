        ...
        <el-row>
            <el-col :span="12">
                <el-form-item label="最小值" prop="minValue">
                    <el-input v-if="!falg" v-model="form.minValue" placeholder="不填写表示不限制最小值" type="number" class="rule-half" />
                    <div v-else class="form-readonly">{{ form.minValue ?? '-' }}</div>
                </el-form-item>
            </el-col>
            <el-col :span="12">
                <el-form-item label="最大值" prop="maxValue">
                    <el-input v-if="!falg" v-model="form.maxValue" placeholder="不填写表示不限制最大值" type="number" class="rule-half" />
...
const includeBoundaryText = computed(() => (form.includeBoundary === '1' ? '包含' : form.includeBoundary === '0' ? '不包含' : '-'));
