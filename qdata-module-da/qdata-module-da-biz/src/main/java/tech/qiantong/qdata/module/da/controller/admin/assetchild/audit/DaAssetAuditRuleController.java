...
@Tag(name = "数据资产质量结果记录")
@RestController
@RequestMapping("/da/daAssetAuditRule")
@Validated
public class DaAssetAuditRuleController extends BaseController {
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.audit:assetauditrule:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.audit:assetauditrule:export')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.audit:assetauditrule:import')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.audit:assetauditrule:query')")
    @GetMapping(value = "/{id}")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.audit:assetauditrule:add')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.audit:assetauditrule:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('da:assetchild.audit:assetauditrule:remove')")
